...
<div id="nav-wrapper">
	<nav>
		...
		<ul class="nav-group-1">
			<li><a class="showSingle" target="1">About</a></li>
			<li><a class="showSingle" target="3">Contact</a></li>
			
		</ul>
		<ul class="nav-group-2">
			<li><a href="<?php echo url() ?>tag:Editorial">Editorial</a></li>
			<li><a href="<?php echo url() ?>tag:Branding">Branding</a></li>
			
		</ul>
		<ul class="nav-group-3">
			<li><a href="<?php echo url() ?>tag:Packaging">Packaging</a></li>
			<li><a href="<?php echo url() ?>tag:Advertising">Advertising</a></li>
			
		</ul>
		<ul class="nav-group-4">
			<li><a href="<?php echo url() ?>tag:Awards+%26+Publications">Awards & Publications</a></li>
			<li><a class="showSearch" target="4">Search</a>
				<div id="div4" class="targetDiv searchBox">
                  <form action="search">
